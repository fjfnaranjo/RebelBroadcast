...
func show_message():
	if not State.active_scene.has_node("Interface/PanelBroadcast"):
		return
	var messagepanel_instance = State.active_scene.get_node("Interface/PanelBroadcast")
	messagepanel_instance.show()
