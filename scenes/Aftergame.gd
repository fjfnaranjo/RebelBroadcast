...
func _ready():
	...
	if (State.win):
		...
		score = "[center]Converted buildings:\t" + str(State.get_score_points())
		score += "\nRemaining time:\t" + str(State.get_remaining_time())
		score += "\n[b]Total Score:\t" + str(State.get_remaining_time() + State.get_score_points()) + "[/b][/center]"
		...
		score = "[center]Converted buildings:\t" + str(State.get_score_points()) + "[/center]"
